                ...
                <div className="col-lg-4 col-md-4 order-1">
                    ...
                    <div className="col-lg-6 col-md-12 col-6 mb-4">
                        ...
                        <div className="card-body">
                            ...
                            <small className="text-success fw-medium"><i className="bx bx-up-arrow-alt" /> +72.80%</small>
                        </div>
                        </div>
                    </div>
                    <div className="col-lg-6 col-md-12 col-6 mb-4">
                        ...
                        <div className="card-body">
                            ...
                            <small className="text-success fw-medium"><i className="bx bx-up-arrow-alt" /> +28.42%</small>
                        </div>
                        </div>
                    </div>
                    </div>
